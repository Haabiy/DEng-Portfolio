...
const Skills = () => {
  ...
  useEffect(() => {
    if (window.location.hash === '#skills' && skillsRef.current) {
      skillsRef.current.scrollIntoView({ behavior: 'smooth' });
    }
  }, []);

  return (
    <section id="skills" ref={skillsRef} className="py-20 px-6 bg-gray-800 text-white">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 cursor-pointer">
